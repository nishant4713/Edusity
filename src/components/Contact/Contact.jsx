...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "5905b3fa-6843-4d15-9597-ac0bebc47ee9");
  ...
  return (
    <div className='contact'>
      <div className='contact-col'>
        ...
        <ul>
            <li><img src={mail_icon}></img>nishantd5117@gmail.com</li>
            <li><img src={phone_icon}></img>+91 8295805989</li>
            <li><img src={location_icon}></img>Sonipat, Haryana</li>
        </ul>
      </div>
      <div className='contact-col'>
